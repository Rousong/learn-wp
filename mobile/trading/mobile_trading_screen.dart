...
import 'package:trade_flex/mobile/trading/widgets/mobile_card_carousel.dart';
      ...
      return NotificationListener<ScrollNotification>(
        onNotification: (ScrollNotification scrollInfo) {
          ...
          if (scrollInfo.metrics.pixels >= scrollInfo.metrics.maxScrollExtent - 100) {
            // 提前100像素开始加载，提供更好的用户体验
            final recordsController = Get.find<MobileTradingRecordsController>();
            recordsController.loadMoreData();
          }
          return false;
        },
