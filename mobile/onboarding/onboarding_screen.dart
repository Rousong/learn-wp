...
/// 
/// 用于 EULA 页面，禁止用户左右滑动
class NoSwipeScrollPhysics extends ScrollPhysics {
  const NoSwipeScrollPhysics({super.parent});

  @override
  NoSwipeScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return NoSwipeScrollPhysics(parent: buildParent(ancestor));
  }

  @override
  bool shouldAcceptUserOffset(ScrollMetrics position) {
    return false; // 禁用所有用户滑动
  }
}
            ...
            children: [
              ...
              Obx(() => PageView.builder(
                ...
                physics: controller.currentPage.value == 0 
                    ? const NoSwipeScrollPhysics() // EULA 页面禁用滑动
                    : const MobilePageViewScrollPhysics(), // 其他页面允许滑动
                onPageChanged: (page) {
