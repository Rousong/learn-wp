                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Obx(() => _buildInfoRow('投资类型', controller.getPortfolioTypeLabel(controller.portfolioType.value))),
                      const SizedBox(height: 12),
                      Obx(() => _buildInfoRow('交易方向', controller.getDirectionLabel(controller.portfolioDirection.value))),
                    ],
                  ),
                ),
