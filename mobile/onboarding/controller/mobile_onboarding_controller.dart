...
class MobileOnboardingController extends GetxController {
  ...
  final Rx<PortfolioCurrency> portfolioCurrency = PortfolioCurrency.cny.obs;
  ...
  void initPortfolioData() {
    ...
    portfolioCurrency.value = PortfolioCurrency.cny;
  ...
  /// 设置币种
  void setCurrency(PortfolioCurrency currency) {
    portfolioCurrency.value = currency;
  }
  
  /// 设置投资组合类型
  void setPortfolioType(PortfolioType type) {
    portfolioType.value = type;
  }
  
  /// 设置交易方向
  void setDirection(PortfolioDirection direction) {
    portfolioDirection.value = direction;
  }
  ...
  Map<String, dynamic> getOnboardingData() {
    return {
      ...
      'portfolioCurrency': PortfolioUtils.getCurrencyCode(portfolioCurrency.value),
  ...
  /// 获取币种显示名称
  String getCurrencyLabel(PortfolioCurrency currency) {
    return PortfolioUtils.getCurrencyFullLabel(PortfolioUtils.getCurrencyCode(currency));
  }
  
  /// 获取投资组合类型显示名称
  String getPortfolioTypeLabel(PortfolioType type) {
    return PortfolioUtils.getPortfolioTypeLabel(type);
  }
  
  /// 获取交易方向显示名称
  String getDirectionLabel(PortfolioDirection direction) {
    return PortfolioUtils.getDirectionLabel(direction);
  }
} 