  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Map<String, dynamic>>(
      ...
      future: Future.wait([
        ...
        UserSettingsRepository.instance.loadSetting('theme_mode'),
      ...
      builder: (context, snapshot) {
        ...
        final themeMode = themeModeString != null ? _parseThemeMode(themeModeString) : ThemeMode.system;
        ...
        if (!isOnboardingCompleted) {
          ...
          return GetMaterialApp(
            ...
            themeMode: themeMode,
            translations: AppTranslations(), // 添加翻译配置
            locale: userLocale ?? Get.deviceLocale, // 使用保存的语言设置或设备语言
            fallbackLocale: const Locale('en', 'US'), // 默认语言
            defaultTransition: Transition.fadeIn, // 添加默认转场效果，与主应用保持一致
        ...
        return GetMaterialApp(
          ...
          locale: userLocale ?? Get.deviceLocale, // 使用保存的语言设置或设备语言
          fallbackLocale: const Locale('en', 'US'), // 默认语言
          initialRoute: MobileRoutes.trading, // 始终从交易页面开始，让各页面自己处理空状态
