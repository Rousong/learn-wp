...
class _MobileAddTradeScreenState extends State<MobileAddTradeScreen>
  ...
  Widget _buildMobileDatePicker() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('交易日期', style: TextStyle(fontWeight: FontWeight.w500)),
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.token, size: 18, color: Colors.grey[600]),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintText: '输入价格',
            hintStyle: TextStyle(color: Colors.grey[400], fontSize: 13),
            prefixIcon: Icon(Icons.attach_money, size: 18, color: Colors.grey[600]),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(color: Colors.grey.shade300),
            ),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintText: '交易数量',
            hintStyle: TextStyle(color: Colors.grey[400], fontSize: 13),
            prefixIcon: Icon(Icons.numbers, size: 18, color: Colors.grey[600]),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(color: Colors.grey.shade300),
            ),
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  fillColor: (!subPositionEnabled || readOnly) ? Colors.grey.shade100 : null,
                ),
      ...
      return Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('恐惧贪婪指数', style: TextStyle(fontWeight: FontWeight.w500)),
              Container(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintText: '输入标签，用空格分隔',
            hintStyle: TextStyle(color: Colors.grey[400], fontSize: 13),
            prefixIcon: Icon(Icons.label, size: 18, color: Colors.grey[600]),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(color: Colors.grey.shade300),
            ),
  ...
  Widget _buildMobileTagCloud() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('常用标签', style: TextStyle(fontWeight: FontWeight.w500)),
        const SizedBox(height: 8),
        Obx(() {
  ...
  Widget _buildMobileAssetBInput() {
    return Column(
      ...
      children: [
        Row(
          children: [
            const Text('资产B代码', style: TextStyle(fontWeight: FontWeight.w500)),
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: '输入或选择资产B',
                  hintStyle: TextStyle(color: Colors.grey[400], fontSize: 13),
                  prefixIcon: Icon(Icons.currency_exchange, size: 18, color: Colors.grey[600]),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
                    borderSide: BorderSide(color: Colors.grey.shade300),
                  ),
  ...
  Widget _buildMobileSubPositionBInput() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('子持仓 (资产B)', style: TextStyle(fontWeight: FontWeight.w500)),
        const SizedBox(height: 8),
        Obx(() {
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(color: Colors.grey[400], fontSize: 13),
                  prefixIcon: Icon(Icons.layers, size: 18, color: Colors.grey[600]),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
                    borderSide: BorderSide(color: Colors.grey.shade300),
                  ),
                  ...
                  fillColor: (!enabled || loading) ? Colors.grey.shade100 : null,
                ),
